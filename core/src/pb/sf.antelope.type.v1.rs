...
pub struct Block {
    ...
    pub action_mroot_savanna: ::prost::alloc::vec::Vec<u8>,
    /// the LIB post-Savanna activation, pre-Savanna this is found in dpos_irreversible_blocknum
    #[prost(uint32, tag="61")]
    pub finality_lib: u32,
    #[prost(message, optional, tag="62")]
    pub finality_data: ::core::option::Option<FinalityData>,
    #[prost(message, optional, tag="63")]
    pub proposer_policy: ::core::option::Option<ProposerPolicy>,
    #[prost(message, optional, tag="64")]
    pub finalizer_policy: ::core::option::Option<FinalizerPolicy>,
...
pub struct FinalityData {
    ...
    pub reversible_blocks_mroot: ::prost::alloc::vec::Vec<u8>,
    #[prost(uint32, tag="6")]
    pub latest_qc_claim_block_num: u32,
    #[prost(bytes="vec", tag="7")]
    pub latest_qc_claim_finality_digest: ::prost::alloc::vec::Vec<u8>,
    #[prost(message, optional, tag="8")]
    pub latest_qc_claim_timestamp: ::core::option::Option<::prost_types::Timestamp>,
    #[prost(bytes="vec", tag="9")]
    pub base_digest: ::prost::alloc::vec::Vec<u8>,
    #[prost(message, optional, tag="10")]
    pub pending_finalizer_policy: ::core::option::Option<FinalizerPolicy>,
    #[prost(uint32, tag="11")]
...
pub struct FinalizerPolicy {
    ...
    pub finalizers: ::prost::alloc::vec::Vec<FinalizerAuthority>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct ProposerPolicy {
    ...
    #[prost(message, optional, tag="2")]
    pub proposer_schedule: ::core::option::Option<ProducerAuthoritySchedule>,
}
/// Present in EOSIO 2.x only
///
...
pub struct BlockHeader {
    ...
    #[prost(message, repeated, tag="12")]
    pub decoded_header_extensions: ::prost::alloc::vec::Vec<BlockHeaderExtension>,
    /// EOSIO 1.x only
    ///
...
pub struct BlockHeaderExtension {
    ...
    pub extension: ::core::option::Option<block_header_extension::Extension>,
}
...
pub struct ProducerScheduleChangeExtension {
    #[prost(message, optional, tag="1")]
    pub producer_schedule: ::core::option::Option<ProducerAuthoritySchedule>,
}
